...
<head>
    ...
    <title>Logowanie - Animatronic Parts</title>
    ...
    <style>
        ...
        /* Accessibility panel styles (copied from welcome/register) */
        #a11y-panel {
            position: fixed;
            top: 100px;
            right: 0;
...
<body>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="{{ route('auth.login.post') }}">
            ...
            <button type="submit" class="btn btn-action mb-3">Zaloguj się</button>
            
            <div class="text-center">
                <p>Nie masz konta? <a href="{{ route('auth.register') }}">Zarejestruj się</a></p>
            </div>
        </form>
        
        <div class="text-center mt-4 small">
            <p style="color: #adb5bd;">Demo konta:</p>
